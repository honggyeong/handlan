...
- 인공지능, 딥러닝, 컴퓨터 비전 등 최신 IT 기술을 직접 구현
...
## 프로젝트 회고 및 느낀 점
- 인공지능, 컴퓨터 비전, 데이터 자동화 등 다양한 최신 기술을 직접 체험 및 구현현할 수 있었음
- 실제로 손동작을 녹화하고, 인공지능이 예측하는 과정을 보며 기술의 원리를 몸소 이해할 수 있었음
- 문제 발생 시 원인을 분석하고, 반복적으로 개선하는 과정에서 문제해결력이 크게 향상됨
...
- 다양한 수어(hello, thankyou, goodbye 외의 여러 단어 등)를 추가해보고, 모델의 성능 변화를 실험
